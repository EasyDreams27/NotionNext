...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '轻言易梦', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '犹是如风一男孩', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hexo.xslover.xyz', // 网站地址
